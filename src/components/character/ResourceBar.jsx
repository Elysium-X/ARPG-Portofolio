  ...
  return (
    <div className="group flex items-center gap-3 p-3 glass-effect rounded-xl transition-colors">
      ...
      <div className="flex-1">
        ...
        <div className={`h-6 ${bgColor} rounded-full overflow-hidden border-2 border-gray-900 shadow-inner relative`}>
          <div
          ...
          >
            <span className="drop-shadow-lg relative z-10">{value} / {max}</span>
            {/* Shimmer animation */}
